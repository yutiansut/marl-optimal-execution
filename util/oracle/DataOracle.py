...
from util.util import log_print, print
...
class DataOracle:
    def __init__(self, historical_date=None, symbols=None, data_dir=None):
        ...
        trade_file = os.path.join(
            data_dir, "trades", "trades_{}".format(h.year), "{}_{}{:02d}{:02d}.bgz".format(pre, h.year, h.month, h.day)
        )

        bars_1m_file = os.path.join(
            data_dir,
            "1m_ohlc",
            "1m_ohlc_{}".format(h.year),
