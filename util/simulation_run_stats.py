...
def get_experiment_statistics(expt_path):
    ...
    for path in glob(f"{expt_path}/*__*.err"):
        ...
        run_dict = {"run_path": path, "run_param_value": param_value, "run_stats": run_stats}
...
if __name__ == "__main__":
    ...
    for col in cols[1:-1]:
        ...
        plt.show()
        fig.savefig(
            f"timings-plots/{col}.png", format="png", dpi=300, transparent=False, bbox_inches="tight", pad_inches=0.03
        )
