...
def extract_events_from_stream(stream_df, event_type):
    ...
    if not event_extracted.empty:
        ...
        event_extracted = pd.DataFrame({"TIMESTAMP": [], "ORDER_ID": [], "PRICE": [], "SIZE": [], "BUY_SELL_FLAG": []})
...
if __name__ == "__main__":
    ...
    parser.add_argument("format", choices=["plot-scripts", "LOBSTER"], type=str, help="Output format of stream")
