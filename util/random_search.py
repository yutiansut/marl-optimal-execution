...
def parse_cli():
    parser = argparse.ArgumentParser(
        description="Prints a random selection of the Cartesian product of a group of lists."
    )
    parser.add_argument("-l", "--list", nargs="+", action="append", help="Start of list", required=True, type=numeric)
