...
class EtfMarketMakerAgent(EtfArbAgent):
    ...
    def kernelStarting(self, startTime):
        ...
        log_print("Agent {} requested agent of type Agent.EtfPrimaryAgent.  Given Agent ID: {}", self.id, self.primeID)
    ...
    def placeBasketOrder(self, quantity, is_create_order):
        ...
        self.sendMessage(self.primeID, Message({"msg": "BASKET_ORDER", "sender": self.id, "order": order}))
