...
class SumClientAgent(Agent):
    ...
    def kernelStarting(self, startTime):
        ...
        log_print(
            "Agent {} requested agent of type Agent.SumServiceAgent.  Given Agent ID: {}", self.id, self.serviceAgentID
        )
    ...
    def wakeup(self, currentTime):
        ...
        if not self.peer_exchange_complete:
            ...
            self.sendMessage(self.serviceAgentID, Message({"msg": "SUM_QUERY", "sender": self.id, "n1": n1, "n2": n2}))
        ...
        if msg.body["msg"] == "PEER_EXCHANGE":
            ...
            if msg.body["sender"] not in self.peers_received:
                ...
                if len(self.peers_received) == len(self.peer_list):
                    ...
                    log_print(
                        "agent {} heard from final peer.  peers_received = {}, peer_sum = {}",
                        self.id,
                        self.peers_received,
                        self.peer_sum,
                    )
