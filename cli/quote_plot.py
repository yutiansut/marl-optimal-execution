...
axes[0].legend(["Best Bid Price", "Best Ask Price", "Midpoint"])
axes[1].legend(["Best Bid Volume", "Best Ask Volume"])

plt.suptitle("Best Bid/Ask for {} stock".format(symbol), y=0.91)

axes[0].set_ylabel("Quote Price ($)")
axes[1].set_xlabel("Quote Time (normalized)")
axes[1].set_ylabel("Quote Volume (units)")
