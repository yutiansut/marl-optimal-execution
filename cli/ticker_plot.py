...
plt.suptitle("Execution Price/Volume for {} stock".format(symbol), y=0.91)

axes[0].set_ylabel("Executed Price ($)")

colors = ["orange", "g", "r", "k"]
lines = [Line2D([0], [0], color=c, linewidth=3) for c in colors]
labels = ["Simulated", "Long Order", "Short Order", "Exit Order"]
...
if PRINT_VOLUME:
    ...
    axes[0].set_xlabel("Execution Time (from 09:30 to 16:00)")
